...
Route::get('/news', [BbsController::class, 'news']);  
Route::view('/shab', 'shab');
Auth::routes();
...
Route::get('/home/{bb}/delete', [HomeController::class, 'showDeleteBbForm'])->name('bb.delete')->middleware('can:update,bb');
Route::delete('/home/{bb}', [HomeController::class, 'destroyBb'])->name('bb.destroy')->middleware('can:update,bb');
